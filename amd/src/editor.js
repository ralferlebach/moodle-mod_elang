...
const STRING_KEYS = [
    ...
    'editor:currentmedia', 'editor:deletecue',
    'editor:emptytranscript', 'editor:gapcount',
    'editor:insertafter', 'editor:insertbefore', 'editor:invalidtime',
    'editor:nocueselected', 'editor:nocuesmatch', 'editor:onlywarnings', 'editor:searchcues',
    'editor:warnemptysolution', 'editor:warnnotranscript', 'editor:warntiming',

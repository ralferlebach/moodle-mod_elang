...
$string['editor_cuenotsaved'] = 'لم يُحفظ';
...
$string['editor_gaphasalternatives'] = 'له صيغ مقبولة';
$string['editor_gaphashints'] = 'له تلميحات';
$string['editor_gapmode_exact'] = 'تطابق تام';
$string['editor_gapmode_wordrecognized'] = 'تُقبل الإجابات القريبة';
$string['editor_gaprange'] = 'موضع الفراغ (بالأحرف)';
$string['editor_gapunplaceable_outofrange'] = 'هذه الفجوة خارج النص ولا يمكن عرضها في موضعها.';
$string['editor_gapunplaceable_overlap'] = 'هذه الفجوة تتداخل مع أخرى ولا يمكن عرضها في موضعها.';
...
$string['editor_problem_afterduration'] = 'وقت النهاية يقع بعد نهاية الوسيط.';
$string['editor_problem_endbeforestart'] = 'وقت النهاية يساوي وقت البداية أو يسبقه.';
$string['editor_problem_negativestart'] = 'وقت البداية يسبق بداية التسجيل.';
$string['editor_publish'] = 'نشر';
$string['editor_publishblocked'] = 'تعذّر حتى الآن حفظ بعض العناوين. صحّحها قبل النشر.';
$string['editor_published'] = 'نُشرت النسخة.';
$string['editor_removehint'] = 'إزالة التلميح';
$string['editor_removevariant'] = 'إزالة';
$string['editor_repaircue'] = 'تصحيح وقت النهاية';
...
$string['editor_savedwithproblems'] = 'حُفظ ما أمكن حفظه؛ بعض العناوين تحتاج انتباهًا.';

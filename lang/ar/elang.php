...
$string['allowedlanguages_desc'] = 'لغات المحتوى المعروضة عند إنشاء نشاط ‏eLang أو تحريره. لا تختر أياً منها لعرض قائمة اللغات كاملة. يحتفظ النشاط باللغة المخزَّنة فيه حتى لو أزلتها من هنا لاحقاً.';
...
$string['cuepausemode'] = 'التوقف عند حدود الترجمة';
$string['cuepausemode_auto'] = 'تلقائي';
$string['cuepausemode_help'] = 'ما إذا كان الوسيط يتوقف عند نهاية الترجمة.

* تلقائي — يستمر التشغيل، ولا يتوقف عند نهاية ترجمة إلا ما دام العمل جارياً عليها، أي بعد النقر عليها أو على أحد فراغاتها، أو بعد نقل تركيز لوحة المفاتيح إلى أحدها.
* التوقف عند كل ترجمة غير مُجابة — يتوقف التشغيل عند نهاية كل ترجمة ما يزال فيها فراغ فارغ، وينتظر الاستئناف.
* عدم التوقف أبداً — يستمر التشغيل حتى نهاية الوسيط.

لا يتوقف أي من الخيارين الأولين عند ترجمة امتلأت كل فراغاتها: فذلك عمل منجَز، والتوقف هناك يطلب ضغطة مفتاح بلا فائدة. وهذا يعني أيضاً أن المرور الثاني على التمرين لا يتوقف إلا حيث ما يزال هناك نقص.';
$string['cuepausemode_nostop'] = 'عدم التوقف أبداً';
$string['cuepausemode_stop'] = 'التوقف عند كل ترجمة غير مُجابة';
...
$string['editor_import'] = 'استيراد الترجمات';
...
$string['editor_importedcues'] = 'تم استيراد {$a} مقطع.';
$string['editor_importfilehint'] = 'اختر ملف ‏WebVTT ‏(.vtt) أو ‏SubRip ‏(.srt) يحتوي على ترجمات.';
...
$string['editor_importreplacedcues'] = 'استُبدلت المقاطع بـ {$a} مقطع مستورد.';
...
$string['editor_importwrongtype'] = 'اختر ملف ترجمة ({$a}).';
...
$string['editor_nocues'] = 'لا توجد مقاطع بعد. أضف مقطعاً أو استورد ترجمات.';
...
$string['editor_nomedianotice'] = 'أضف ملف الفيديو أو الصوت في تبويب الوسائط أولاً. تُوقَّت الترجمات على الوسيط، لذا يحتاجه المحرر قبل أن تتمكن من العمل على المقاطع والفراغات.';
...
$string['editor_onboardingimport'] = 'استورد ترجمات ‏WebVTT أو ‏SubRip، أو أضف المقاطع يدوياً.';
...
$string['editor_starttime'] = 'البداية (مللي ثانية)';
...
$string['elang:addinstance'] = 'إضافة تمرين لغوي جديد';
$string['elang:attempt'] = 'محاولة تمرين لغوي';
...
$string['elang:view'] = 'عرض تمرين لغوي';
...
$string['error_importnocues'] = 'تعذرت قراءة أي ترجمة من هذا المحتوى. يحتوي ملف ‏WebVTT أو ‏SubRip على سطر توقيت مثل 00:00:01.000 --> 00:00:04.000 فوق كل ترجمة.';
...
$string['error_importtoolarge'] = 'حجم هذا الملف {$a->size}؛ الاستيراد يقبل {$a->max} كحد أقصى. ملف الترجمة لتسجيل درس أصغر من ذلك بكثير، لذا من غير المرجح أن يكون هذا ملف ترجمة.';
$string['error_importtoomanycues'] = 'يحتوي هذا الملف على {$a->count} ترجمة؛ الاستيراد يقبل {$a->max} كحد أقصى.';
$string['error_invalidcuepausemode'] = 'اختر أحد الخيارات المعروضة للتوقف عند حدود الترجمة.';
...
$string['error_invalidsubtitleposition'] = 'اختر أحد الخيارات المعروضة لموضع عرض الترجمات.';
...
$string['export_audiencestaff'] = 'للمعلمين والمرشدين فقط — غير متاح للمتعلمين';
...
$string['import_warnlinetoolong'] = 'تم تخطي الكتلة {$a->block}: تحتوي على سطر يتجاوز {$a->max} حرفاً، وهذا ليس سطر ترجمة.';
$string['jarothreshold'] = 'عتبة المطابقة التقريبية';
$string['jarothreshold_help'] = 'بالنسبة للفراغات التي تقبل الإجابات المقاربة (خوارزمية «الكلمة المعروفة»)، هذه هي أدنى درجة تشابه ‏Jaro، من 0 إلى 1، بين الصيغتين المختصرتين حتى تُحتسب إجابة غير مطابقة تماماً صحيحةً. القيمة 1 تتطلب اختصاراً مطابقاً — بلا أي تسامح — بينما تقبل القيم الأدنى فروقاً أكبر. تبدأ النسخ الجديدة من هذا النشاط بهذه القيمة.';
$string['jarothresholdrange'] = 'يجب أن تكون العتبة بين 0 و1.';
$string['language'] = 'لغة المحتوى';
$string['language_help'] = 'رمز لغة محتوى التمرين أو رمز كتابته، مثل ‏de أو ‏fr أو ‏zh-Hans أو ‏ja. يتحكم في كيفية مقارنة الإجابات، بما في ذلك توحيد حالة الأحرف والنقحرة. اتركه فارغاً للمعالجة العامة. تبدأ النسخ الجديدة من هذا النشاط بهذه القيمة.';
$string['language_none'] = 'عام (غير محدد)';
$string['media_cuenote'] = 'تبقى الترجمات والفراغات الموجودة كما هي عند تغيير الوسيط. لا تُعدَّل توقيتاتها، لذا راجعها في المحرر بعد ذلك.';
$string['media_current'] = 'الوسيط الحالي';
$string['media_heading'] = 'الوسائط';
$string['media_intro'] = 'اختر الفيديو أو الصوت الذي يقوم عليه هذا التمرين. تُوقَّت الترجمات عليه، لذا يأتي أولاً.';
...
$string['migratev1_parseerrorcount'] = 'تعذر تحليل {$a} مقطع';
...
$string['migratev1_verifieddiscrepancies'] = 'وجد التحقق {$a} اختلافاً مقارنةً بمصدر الإصدار 1:';
$string['migratev1_verifyfailed'] = 'تعذر التحقق من هذا النشاط: {$a}';
$string['modulename'] = 'تمرين لغوي';
$string['modulename_help'] = 'يتيح نشاط التمرين اللغوي للمتعلمين ملء الفراغات في ترجمات موقَّتة زمنياً أثناء مشاهدة فيديو أو الاستماع إليه.

يستورد المعلمون ملف ترجمة بصيغة ‏WebVTT أو ‏SubRip، ويعلّمون كلمات أو عبارات كفراغات، ويضبطون مدى صرامة مقارنة الإجابات. يعمل المتعلمون على النص مقطعاً بمقطع، ويطلبون تلميحات مُقيَّمة، ويتلقون تغذية راجعة فورية.';
$string['modulenameplural'] = 'تمارين لغوية';
$string['nav_exportshort'] = 'تصدير';
$string['nav_media'] = 'الوسائط';
$string['nav_reports'] = 'المحاولات';
$string['nav_subtitles'] = 'الترجمات والفراغات';
$string['noinstances'] = 'لا توجد تمارين لغوية في هذه الدورة.';
$string['overview_attempts'] = 'المحاولات';
$string['playbackheading'] = 'التشغيل والترجمات';
$string['playbackoverlayhint'] = 'تعرض الترجمة الموضوعة على الصورة المقطع الجاري تشغيله فقط، لذا يتوقف التشغيل دائماً عند نهاية أي مقطع ما تزال فيه فراغات لتُملأ. لا يوجد خيار هنا.';
$string['playbackproviderhint'] = 'يُشغَّل فيديو ‏YouTube أو ‏Vimeo لدى المزود في إطاره الخاص، وهو لا يُبلّغ عن وقت التشغيل. لذا يعرض هذا التمرين الترجمات دائماً أسفل الوسيط ولا يتوقف عند حدود الترجمة، مهما كان الاختيار أعلاه. أما الملفات المرفوعة وروابط الوسائط المباشرة فتحترم كلا الإعدادين.';
...
$string['player_finishincomplete'] = 'ما يزال {$a} فراغاً فارغاً. هل تريد إنهاء المحاولة على أي حال؟';
...
$string['pluginadministration'] = 'إدارة التمرين اللغوي';
$string['pluginname'] = 'تمرين لغوي';
...
$string['subtitleposition'] = 'عرض الترجمات';
$string['subtitleposition_below'] = 'أسفل الوسيط';
$string['subtitleposition_help'] = 'أين تُعرض الترجمات التفاعلية.

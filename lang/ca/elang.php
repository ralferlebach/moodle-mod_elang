...
$string['editor_cuenotsaved'] = 'Sense desar';
...
$string['editor_gaphasalternatives'] = 'té variants acceptades';
$string['editor_gaphashints'] = 'té pistes';
$string['editor_gapmode_exact'] = 'coincidència exacta';
$string['editor_gapmode_wordrecognized'] = 's’accepten respostes properes';
$string['editor_gaprange'] = 'Posició del buit (caràcters)';
$string['editor_gapunplaceable_outofrange'] = 'Aquest buit és fora del text i no es pot mostrar al seu lloc.';
$string['editor_gapunplaceable_overlap'] = 'Aquest buit se superposa a un altre i no es pot mostrar al seu lloc.';
...
$string['editor_problem_afterduration'] = 'El final és posterior al final del mitjà.';
$string['editor_problem_endbeforestart'] = 'El final coincideix amb l’inici o hi és anterior.';
$string['editor_problem_negativestart'] = 'L’inici és anterior al començament de l’enregistrament.';
$string['editor_publish'] = 'Publica';
$string['editor_publishblocked'] = 'Alguns subtítols encara no es poden desar. Corregiu-los abans de publicar.';
...
$string['editor_repaircue'] = 'Corregeix el final';
...
$string['editor_savedwithproblems'] = 'S’ha desat el que es podia desar; alguns subtítols necessiten atenció.';
...
$string['player_exitfullscreen'] = 'Surt de la pantalla completa';

...
$string['editor_gaphasalternatives'] = 'má přijímané varianty';
$string['editor_gaphashints'] = 'má nápovědy';
$string['editor_gapmode_exact'] = 'přesná shoda';
$string['editor_gapmode_wordrecognized'] = 'blízké odpovědi se přijímají';
$string['editor_gaprange'] = 'Pozice mezery (znaky)';
$string['editor_gapunplaceable_outofrange'] = 'Tato mezera leží mimo text a nelze ji zobrazit na jejím místě.';
$string['editor_gapunplaceable_overlap'] = 'Tato mezera se překrývá s jinou a nelze ji zobrazit na jejím místě.';

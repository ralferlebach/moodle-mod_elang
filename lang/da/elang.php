...
$string['editor_gaphasalternatives'] = 'har accepterede varianter';
$string['editor_gaphashints'] = 'har hjælp';
$string['editor_gapmode_exact'] = 'nøjagtigt match';
$string['editor_gapmode_wordrecognized'] = 'nære svar accepteres';
$string['editor_gaprange'] = 'Hullets placering (tegn)';
$string['editor_gapunplaceable_outofrange'] = 'Dette hul ligger uden for teksten og kan ikke vises på sin plads.';
$string['editor_gapunplaceable_overlap'] = 'Dette hul overlapper et andet og kan ikke vises på sin plads.';

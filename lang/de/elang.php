...
$string['editor:advanced'] = 'Erweiterte Einstellungen';
...
$string['editor:cueactions'] = 'Cue-Aktionen';
...
$string['editor:insertafter'] = 'Cue danach einfügen';
$string['editor:insertbefore'] = 'Cue davor einfügen';
$string['editor:invalidtime'] = 'Geben Sie eine Zeit als mm:ss.SSS an, zum Beispiel 01:05.400.';
$string['editor:linkurl'] = 'Nachschlage-Link';
$string['editor:linkurl_help'] = 'Wird neben der Lücke als Nachschlagemöglichkeit angeboten. Leer lassen für keinen.';
...
$string['editor:maxlength'] = 'Maximale Länge';
$string['editor:maxlength_help'] = 'Begrenzt, wie viel Lernende eingeben können. 0 bedeutet keine Begrenzung.';
...
$string['editor:nocueselected'] = 'Wählen Sie links einen Cue aus, um ihn zu bearbeiten.';
$string['editor:nocuesmatch'] = 'Kein Cue passt zu dieser Suche.';
...
$string['editor:onlywarnings'] = 'Nur Cues mit Warnungen';
...
$string['editor:searchcues'] = 'Cues suchen';
...
$string['editor:variantisregex'] = '{$a} als regulären Ausdruck behandeln';
$string['editor:variantmatching'] = 'Wie die akzeptierten Varianten verglichen werden';
$string['editor:warnemptysolution'] = 'Eine Lücke hat keine Lösung';
$string['editor:warnnotranscript'] = 'Kein Text';
$string['editor:warntiming'] = 'Ende liegt nicht nach dem Start';
...
$string['player:finishincomplete'] = '{$a} Lücke(n) sind noch leer. Versuch trotzdem abschließen?';
...
$string['player:progress'] = '{$a->done} von {$a->total} Lücken beantwortet';
...
$string['report:filterany'] = 'Alle';
$string['report:filterapply'] = 'Filter anwenden';
$string['report:filterattempt'] = 'Versuchsnummer';
$string['report:filterfrom'] = 'Begonnen ab';
$string['report:filterrangeerror'] = 'Das Ende des Zeitraums liegt vor seinem Anfang.';
$string['report:filterreset'] = 'Filter zurücksetzen';
$string['report:filterstate'] = 'Status';
$string['report:filterto'] = 'Begonnen bis';
$string['report:filteruser'] = 'Person';
$string['report:finished'] = 'Beendet';
$string['report:heading'] = 'Versuche';
$string['report:hinted'] = 'Mit Hinweis';
$string['report:hints'] = 'Hinweisstufe';
$string['report:kpianswered'] = 'Beantwortet';
$string['report:kpiattempts'] = 'Angezeigte Versuche';
$string['report:kpiaverage'] = 'Durchschnitt (abgeschlossen)';
$string['report:kpicorrect'] = 'Akzeptiert';
$string['report:kpiexact'] = 'Genau richtig';
$string['report:kpifinished'] = 'Abgeschlossen';
$string['report:kpihinted'] = 'Mit Hinweis';
$string['report:kpihintedgaps'] = 'Mit Hinweis';
$string['report:noattempts'] = 'Noch keine Versuche.';
$string['report:nogaps'] = 'Die Version, auf der dieser Versuch beruht, enthält keine Lücken.';
$string['report:nomatchingattempts'] = 'Kein Versuch passt zu diesen Filtern.';
$string['report:noresponse'] = 'Nicht beantwortet';
...
$string['report:started'] = 'Begonnen';

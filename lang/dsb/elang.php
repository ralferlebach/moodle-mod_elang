...
$string['editor_gaphasalternatives'] = 'ma dowólone warianty';
$string['editor_gaphashints'] = 'ma pókiwy';
$string['editor_gapmode_exact'] = 'dokradne wótpowědowanje';
$string['editor_gapmode_wordrecognized'] = 'pódobne wótegrona dowólone';
$string['editor_gaprange'] = 'Pozicija proznotki (znamuška)';
$string['editor_gapunplaceable_outofrange'] = 'Toś ta proznotka lažy zwenka teksta a njedajo se na swójom městnje pokazaś.';
$string['editor_gapunplaceable_overlap'] = 'Toś ta proznotka se z drugeju pśekšywa a njedajo se na swójom městnje pokazaś.';
...
$string['editor_problem_afterduration'] = 'Kóńc lažy za kóńcom medija.';
$string['editor_problem_endbeforestart'] = 'Kóńc jo samski ako zachopjeńk abo pśed nim.';
$string['editor_problem_negativestart'] = 'Zachopjeńk lažy pśed zachopjeńkom nagraśa.';
$string['editor_publish'] = 'Wózjawiś';
$string['editor_publishblocked'] = 'Někotare pódtitele njedaju se hyšći składowaś. Porěźćo je pśed wózjawjenim.';
$string['editor_published'] = 'Wersija jo wózjawjona.';
$string['editor_removehint'] = 'Pókiw wótpóraś';
$string['editor_removevariant'] = 'Wótpóraś';
$string['editor_repaircue'] = 'Kóńc porěźiś';
...
$string['editor_savedwithproblems'] = 'Składowało jo se, což jo se składowaś dało; někotare pódtitele trjebaju kedźbnosć.';

...
$string['allowedlanguages_desc'] = 'Οι γλώσσες περιεχομένου που προσφέρονται κατά τη δημιουργία ή επεξεργασία μιας δραστηριότητας eLang. Μην επιλέξετε καμία για να προσφέρεται ολόκληρη η λίστα. Μια δραστηριότητα διατηρεί την αποθηκευμένη γλώσσα της ακόμη κι αν την αφαιρέσετε αργότερα από εδώ.';
...
$string['editor_cuecount'] = '{$a} τμήμα(τα)';
...
$string['editor_importedcues'] = 'Εισήχθησαν {$a} τμήμα(τα).';
...
$string['editor_importreplacedcues'] = 'Τα τμήματα αντικαταστάθηκαν με {$a} εισαγόμενα τμήματα.';
...
$string['editor_starttime'] = 'Έναρξη (ms)';
...
$string['elang:addinstance'] = 'Προσθήκη νέας γλωσσικής άσκησης';
$string['elang:attempt'] = 'Εκτέλεση γλωσσικής άσκησης';
...
$string['elang:view'] = 'Προβολή γλωσσικής άσκησης';
...
$string['export_audiencestaff'] = 'Μόνο για διδάσκοντες — δεν προσφέρεται στους μαθητές';
...
$string['jarothreshold'] = 'Κατώφλι προσεγγιστικής αντιστοίχισης';
$string['jarothreshold_help'] = 'Για τα κενά που δέχονται παρόμοιες απαντήσεις (ο αλγόριθμος «αναγνωρισμένη λέξη»), αυτή είναι η ελάχιστη ομοιότητα Jaro, από 0 έως 1, μεταξύ των ανηγμένων μορφών ώστε μια μη πανομοιότυπη απάντηση να μετρήσει ως σωστή. Το 1 απαιτεί πανομοιότυπη αναγωγή — καμία ανοχή — ενώ οι χαμηλότερες τιμές δέχονται μεγαλύτερες αποκλίσεις. Οι νέες εκδόσεις αυτής της δραστηριότητας ξεκινούν από αυτή την τιμή.';
$string['jarothresholdrange'] = 'Το κατώφλι πρέπει να είναι μεταξύ 0 και 1.';
$string['language'] = 'Γλώσσα περιεχομένου';
$string['language_help'] = 'Ο κωδικός γλώσσας ή γραφής του περιεχομένου της άσκησης, για παράδειγμα de, fr, zh-Hans ή ja. Ελέγχει πώς συγκρίνονται οι απαντήσεις, συμπεριλαμβανομένης της ενοποίησης πεζών-κεφαλαίων και της μεταγραφής. Αφήστε το κενό για γενική μεταχείριση. Οι νέες εκδόσεις αυτής της δραστηριότητας ξεκινούν από αυτή την τιμή.';
...
$string['migratev1_approved'] = 'Το elang {$a} σημειώθηκε ως εγκεκριμένο.';
...
$string['migratev1_parseerrorcount'] = '{$a} τμήμα(τα) δεν μπόρεσαν να αναλυθούν';
...
$string['migratev1_verifieddiscrepancies'] = 'Η επαλήθευση βρήκε {$a} απόκλιση(εις) σε σχέση με την πηγή της έκδοσης 1:';
$string['migratev1_verifyfailed'] = 'Δεν ήταν δυνατή η επαλήθευση αυτής της δραστηριότητας: {$a}';
$string['modulename'] = 'Γλωσσική άσκηση';
$string['modulename_help'] = 'Η δραστηριότητα γλωσσικής άσκησης επιτρέπει στους μαθητές να συμπληρώνουν κενά σε χρονισμένους υπότιτλους ενώ παρακολουθούν ή ακούν ένα βίντεο.
...
$string['player_finishincomplete'] = '{$a} κενό(ά) παραμένουν άδεια. Ολοκλήρωση της προσπάθειας ούτως ή άλλως;';
...
$string['pluginadministration'] = 'Διαχείριση γλωσσικής άσκησης';
$string['pluginname'] = 'Γλωσσική άσκηση';

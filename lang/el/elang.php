...
$string['editor_cuenotsaved'] = 'Δεν αποθηκεύτηκε';
...
$string['editor_gaphasalternatives'] = 'έχει δεκτές παραλλαγές';
$string['editor_gaphashints'] = 'έχει υποδείξεις';
$string['editor_gapmode_exact'] = 'ακριβής αντιστοιχία';
$string['editor_gapmode_wordrecognized'] = 'γίνονται δεκτές παρόμοιες απαντήσεις';
$string['editor_gaprange'] = 'Θέση κενού (χαρακτήρες)';
$string['editor_gapunplaceable_outofrange'] = 'Αυτό το κενό βρίσκεται εκτός του κειμένου και δεν μπορεί να εμφανιστεί στη θέση του.';
$string['editor_gapunplaceable_overlap'] = 'Αυτό το κενό επικαλύπτεται με άλλο και δεν μπορεί να εμφανιστεί στη θέση του.';
...
$string['editor_problem_afterduration'] = 'Η λήξη έπεται του τέλους του μέσου.';
$string['editor_problem_endbeforestart'] = 'Η λήξη συμπίπτει με την έναρξη ή προηγείται.';
$string['editor_problem_negativestart'] = 'Η έναρξη προηγείται της αρχής της εγγραφής.';
$string['editor_publish'] = 'Δημοσίευση';
$string['editor_publishblocked'] = 'Ορισμένοι υπότιτλοι δεν μπορούν ακόμη να αποθηκευτούν. Διορθώστε τους πριν τη δημοσίευση.';
...
$string['editor_repaircue'] = 'Διόρθωση λήξης';
...
$string['editor_savedwithproblems'] = 'Αποθηκεύτηκε ό,τι μπορούσε· ορισμένοι υπότιτλοι χρειάζονται προσοχή.';
...
$string['player_exitfullscreen'] = 'Έξοδος από πλήρη οθόνη';
...
$string['player_fullscreen'] = 'Πλήρης οθόνη';

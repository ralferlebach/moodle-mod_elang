...
$string['editor:advanced'] = 'Advanced settings';
...
$string['editor:linkurl'] = 'Reference link';
$string['editor:linkurl_help'] = 'Shown beside the gap as a place to look the word up. Leave empty for none.';
$string['editor:loaderror'] = 'The editor could not be loaded. Please reload the page.';
$string['editor:loading'] = 'Loading the editor…';
$string['editor:maxlength'] = 'Maximum length';
$string['editor:maxlength_help'] = 'Caps how much a learner can type. 0 means no limit.';
...
$string['editor:variantisregex'] = 'Treat {$a} as a regular expression';
$string['editor:variantmatching'] = 'How the accepted variants are matched';

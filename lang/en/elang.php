...
$string['editor_importedcues'] = 'Cues imported: {$a}';
...
$string['editor_importreplacedcues'] = 'Cues replaced; newly imported: {$a}';
...
$string['migratev1_parseerrorcount'] = 'Cues that could not be parsed: {$a}';

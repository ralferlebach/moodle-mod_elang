...
$string['editor_cuecount'] = '{$a} segmento(s)';
...
$string['editor_gapcount'] = '{$a} hueco(s)';
...
$string['editor_importedcues'] = '{$a} segmento(s) importado(s).';
...
$string['editor_importreplacedcues'] = 'Segmentos sustituidos por {$a} segmento(s) importado(s).';
...
$string['editor_starttime'] = 'Inicio (ms)';
...
$string['elang:addinstance'] = 'Añadir un nuevo ejercicio de idioma';
$string['elang:attempt'] = 'Realizar un ejercicio de idioma';
...
$string['elang:view'] = 'Ver un ejercicio de idioma';
...
$string['export_audiencestaff'] = 'Solo profesores y tutores — no se ofrece a los estudiantes';
...
$string['jarothreshold'] = 'Umbral de coincidencia aproximada';
$string['jarothreshold_help'] = 'Para los huecos que aceptan respuestas próximas (el algoritmo «palabra reconocida»), este es el parecido de Jaro mínimo, de 0 a 1, entre las formas reducidas para que una respuesta no idéntica siga contando como correcta. El valor 1 exige una reducción idéntica — sin tolerancia — mientras que los valores menores aceptan diferencias mayores. Las nuevas versiones de esta actividad parten de este valor.';
$string['jarothresholdrange'] = 'El umbral debe estar entre 0 y 1.';
$string['language'] = 'Idioma del contenido';
$string['language_help'] = 'El código de idioma o de escritura del contenido del ejercicio, por ejemplo de, fr, zh-Hans o ja. Determina cómo se comparan las respuestas, incluidas las mayúsculas y la transliteración. Déjelo vacío para un tratamiento genérico. Las nuevas versiones de esta actividad parten de este valor.';
...
$string['migratev1_parseerrorcount'] = 'No se han podido analizar {$a} segmento(s)';
...
$string['migratev1_verifieddiscrepancies'] = 'La verificación ha encontrado {$a} discrepancia(s) respecto al origen de la versión 1:';
$string['migratev1_verifyfailed'] = 'No se ha podido verificar esta actividad: {$a}';
$string['modulename'] = 'Ejercicio de idioma';
$string['modulename_help'] = 'La actividad de ejercicio de idioma permite a los estudiantes rellenar huecos en subtítulos sincronizados mientras ven o escuchan un vídeo.
...
$string['modulenameplural'] = 'Ejercicios de idioma';
...
$string['noinstances'] = 'No hay ejercicios de idioma en este curso.';
...
$string['player_finishincomplete'] = 'Quedan {$a} hueco(s) vacíos. ¿Finalizar el intento de todos modos?';
...
$string['pluginadministration'] = 'Administración del ejercicio de idioma';
$string['pluginname'] = 'Ejercicio de idioma';

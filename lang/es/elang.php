...
$string['editor_cuenotsaved'] = 'Sin guardar';
...
$string['editor_gaphasalternatives'] = 'tiene variantes aceptadas';
$string['editor_gaphashints'] = 'tiene pistas';
$string['editor_gapmode_exact'] = 'coincidencia exacta';
$string['editor_gapmode_wordrecognized'] = 'se aceptan respuestas próximas';
$string['editor_gaprange'] = 'Posición del hueco (caracteres)';
$string['editor_gapunplaceable_outofrange'] = 'Este hueco está fuera del texto y no se puede mostrar en su lugar.';
$string['editor_gapunplaceable_overlap'] = 'Este hueco se solapa con otro y no se puede mostrar en su lugar.';
...
$string['editor_problem_afterduration'] = 'El final es posterior al final del medio.';
$string['editor_problem_endbeforestart'] = 'El final está en la misma posición que el inicio o antes.';
$string['editor_problem_negativestart'] = 'El inicio es anterior al comienzo de la grabación.';
$string['editor_publish'] = 'Publicar';
$string['editor_publishblocked'] = 'Algunos subtítulos aún no se pueden guardar. Corríjalos antes de publicar.';
$string['editor_published'] = 'Versión publicada.';
$string['editor_removehint'] = 'Quitar la pista';
$string['editor_removevariant'] = 'Quitar';
$string['editor_repaircue'] = 'Corregir el final';
...
$string['editor_savedwithproblems'] = 'Se guardó lo que se pudo guardar; algunos subtítulos necesitan atención.';
...
$string['player_exitfullscreen'] = 'Salir de la pantalla completa';
...
$string['player_fullscreen'] = 'Pantalla completa';

...
$string['editor_cuenotsaved'] = 'Ei tallennettu';
...
$string['editor_gaphasalternatives'] = 'on hyväksyttyjä muunnelmia';
$string['editor_gaphashints'] = 'on vihjeitä';
$string['editor_gapmode_exact'] = 'tarkka vastaavuus';
$string['editor_gapmode_wordrecognized'] = 'läheiset vastaukset hyväksytään';
$string['editor_gaprange'] = 'Aukon sijainti (merkkeinä)';
$string['editor_gapunplaceable_outofrange'] = 'Tämä aukko on tekstin ulkopuolella eikä sitä voi näyttää paikallaan.';
$string['editor_gapunplaceable_overlap'] = 'Tämä aukko menee päällekkäin toisen kanssa eikä sitä voi näyttää paikallaan.';
...
$string['editor_problem_afterduration'] = 'Lopetusaika on median lopun jälkeen.';
$string['editor_problem_endbeforestart'] = 'Lopetusaika on sama kuin aloitusaika tai sitä aiemmin.';
$string['editor_problem_negativestart'] = 'Aloitusaika on ennen tallenteen alkua.';
$string['editor_publish'] = 'Julkaise';
$string['editor_publishblocked'] = 'Joitakin tekstityksiä ei voi vielä tallentaa. Korjaa ne ennen julkaisua.';
$string['editor_published'] = 'Versio julkaistu.';
$string['editor_removehint'] = 'Poista vihje';
$string['editor_removevariant'] = 'Poista';
$string['editor_repaircue'] = 'Korjaa lopetusaika';
...
$string['editor_savedwithproblems'] = 'Tallennettiin se, mikä voitiin; jotkin tekstitykset vaativat huomiota.';

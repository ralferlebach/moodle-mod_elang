...
$string['editor_cuecount'] = '{$a} séquence(s)';
...
$string['editor_importedcues'] = '{$a} séquence(s) importée(s).';
...
$string['editor_importreplacedcues'] = 'Séquences remplacées par {$a} séquence(s) importée(s).';
...
$string['editor_starttime'] = 'Début (ms)';
...
$string['elang:addinstance'] = 'Ajouter un nouvel exercice de langue';
$string['elang:attempt'] = 'Effectuer un exercice de langue';
...
$string['elang:view'] = 'Consulter un exercice de langue';
...
$string['export_audiencestaff'] = 'Enseignants et tuteurs uniquement — non proposé aux participants';
...
$string['jarothreshold'] = 'Seuil de correspondance approchée';
$string['jarothreshold_help'] = 'Pour les blancs qui acceptent les réponses proches (l\'algorithme « mot reconnu »), il s\'agit de la similarité de Jaro minimale, de 0 à 1, entre les formes réduites pour qu\'une réponse non identique compte tout de même comme correcte. La valeur 1 exige une réduction identique — aucune tolérance — tandis que des valeurs plus basses acceptent des écarts plus importants. Les nouvelles versions de cette activité partent de cette valeur.';
$string['jarothresholdrange'] = 'Le seuil doit être compris entre 0 et 1.';
$string['language'] = 'Langue du contenu';
$string['language_help'] = 'Le code de langue ou d\'écriture du contenu de l\'exercice, par exemple de, fr, zh-Hans ou ja. Il détermine la manière dont les réponses sont comparées, y compris la casse et la translittération. Laissez vide pour un traitement générique. Les nouvelles versions de cette activité partent de cette valeur.';
...
$string['migratev1_parseerrorcount'] = '{$a} séquence(s) n\'ont pas pu être analysées';
...
$string['migratev1_verifieddiscrepancies'] = 'La vérification a relevé {$a} écart(s) par rapport à la source de la version 1 :';
$string['migratev1_verifyfailed'] = 'Impossible de vérifier cette activité : {$a}';
$string['modulename'] = 'Exercice de langue';
$string['modulename_help'] = 'L\'activité exercice de langue permet aux participants de compléter des blancs dans des sous-titres minutés tout en regardant ou en écoutant une vidéo.
...
$string['modulenameplural'] = 'Exercices de langue';
...
$string['noinstances'] = 'Il n\'y a aucun exercice de langue dans ce cours.';
...
$string['player_finishincomplete'] = '{$a} blanc(s) sont encore vides. Terminer quand même la tentative ?';
...
$string['pluginadministration'] = 'Administration de l\'exercice de langue';
$string['pluginname'] = 'Exercice de langue';

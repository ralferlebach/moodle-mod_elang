...
$string['editor_gaphasalternatives'] = 'a des variantes acceptées';
$string['editor_gaphashints'] = 'a des indices';
$string['editor_gapmode_exact'] = 'correspondance exacte';
$string['editor_gapmode_wordrecognized'] = 'réponses proches acceptées';
$string['editor_gaprange'] = 'Position du blanc (caractères)';
$string['editor_gapunplaceable_outofrange'] = 'Ce blanc se trouve hors du texte et ne peut pas être montré à sa place.';
$string['editor_gapunplaceable_overlap'] = 'Ce blanc en chevauche un autre et ne peut pas être montré à sa place.';

...
$string['editor_gaphasalternatives'] = 'ha varianti accettate';
$string['editor_gaphashints'] = 'ha suggerimenti';
$string['editor_gapmode_exact'] = 'corrispondenza esatta';
$string['editor_gapmode_wordrecognized'] = 'risposte simili accettate';
$string['editor_gaprange'] = 'Posizione dello spazio (caratteri)';
$string['editor_gapunplaceable_outofrange'] = 'Questo spazio è fuori dal testo e non può essere mostrato al suo posto.';
$string['editor_gapunplaceable_overlap'] = 'Questo spazio si sovrappone a un altro e non può essere mostrato al suo posto.';

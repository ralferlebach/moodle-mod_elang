...
$string['editor_gaphasalternatives'] = '許容する表記あり';
$string['editor_gaphashints'] = 'ヒントあり';
$string['editor_gapmode_exact'] = '完全一致';
$string['editor_gapmode_wordrecognized'] = '近い解答も可';
$string['editor_gaprange'] = '空欄の位置 (文字数)';
$string['editor_gapunplaceable_outofrange'] = 'この空欄は本文の外にあるため、その位置に表示できません。';
$string['editor_gapunplaceable_overlap'] = 'この空欄は他の空欄と重なっているため、その位置に表示できません。';
...
$string['editor_problem_afterduration'] = '終了時間がメディアの末尾より後です。';
$string['editor_problem_endbeforestart'] = '終了時間が開始時間と同じか、それより前です。';
$string['editor_problem_negativestart'] = '開始時間が録画の先頭より前です。';
$string['editor_publish'] = '公開する';
$string['editor_publishblocked'] = 'まだ保存できない字幕があります。公開の前に修正してください。';
$string['editor_published'] = 'バージョンを公開しました。';
$string['editor_removehint'] = 'ヒントを削除する';
$string['editor_removevariant'] = '削除する';
$string['editor_repaircue'] = '終了時間を修正';
...
$string['editor_savedwithproblems'] = '保存できる分は保存しました。いくつかの字幕に対応が必要です。';

...
$string['editor_gaphasalternatives'] = '허용 표기 있음';
$string['editor_gaphashints'] = '힌트 있음';
$string['editor_gapmode_exact'] = '정확히 일치';
$string['editor_gapmode_wordrecognized'] = '비슷한 답도 인정';
$string['editor_gaprange'] = '빈칸 위치 (문자 수)';
$string['editor_gapunplaceable_outofrange'] = '이 빈칸은 본문 밖에 있어 제자리에 표시할 수 없습니다.';
$string['editor_gapunplaceable_overlap'] = '이 빈칸은 다른 빈칸과 겹쳐 제자리에 표시할 수 없습니다.';

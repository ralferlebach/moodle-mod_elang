...
$string['editor_cuenotsaved'] = 'Ikke lagret';
...
$string['editor_gaphasalternatives'] = 'har godtatte varianter';
$string['editor_gaphashints'] = 'har hint';
$string['editor_gapmode_exact'] = 'nøyaktig treff';
$string['editor_gapmode_wordrecognized'] = 'nære svar godtas';
$string['editor_gaprange'] = 'Hullets plassering (tegn)';
$string['editor_gapunplaceable_outofrange'] = 'Dette hullet ligger utenfor teksten og kan ikke vises på plassen sin.';
$string['editor_gapunplaceable_overlap'] = 'Dette hullet overlapper et annet og kan ikke vises på plassen sin.';
...
$string['editor_problem_afterduration'] = 'Sluttiden ligger etter slutten av mediet.';
$string['editor_problem_endbeforestart'] = 'Sluttiden er den samme som starttiden eller ligger før den.';
$string['editor_problem_negativestart'] = 'Starttiden ligger før opptaket begynner.';
$string['editor_publish'] = 'Publiser';
$string['editor_publishblocked'] = 'Noen undertekster kan ikke lagres ennå. Rett dem før du publiserer.';
$string['editor_published'] = 'Versjonen er publisert.';
$string['editor_removehint'] = 'Fjern hintet';
$string['editor_removevariant'] = 'Fjern';
$string['editor_repaircue'] = 'Rett sluttiden';
...
$string['editor_savedwithproblems'] = 'Lagret det som kunne lagres; noen undertekster trenger tilsyn.';

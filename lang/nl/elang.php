...
$string['editor_cuenotsaved'] = 'Niet opgeslagen';
...
$string['editor_gaphasalternatives'] = 'heeft toegestane varianten';
$string['editor_gaphashints'] = 'heeft hints';
$string['editor_gapmode_exact'] = 'exacte overeenkomst';
$string['editor_gapmode_wordrecognized'] = 'vergelijkbare antwoorden toegestaan';
$string['editor_gaprange'] = 'Positie van het invulveld (tekens)';
$string['editor_gapunplaceable_outofrange'] = 'Deze lacune valt buiten de tekst en kan niet op haar plaats worden getoond.';
$string['editor_gapunplaceable_overlap'] = 'Deze lacune overlapt een andere en kan niet op haar plaats worden getoond.';
...
$string['editor_problem_afterduration'] = 'De eindtijd ligt na het einde van het medium.';
$string['editor_problem_endbeforestart'] = 'De eindtijd valt op of vóór de begintijd.';
$string['editor_problem_negativestart'] = 'De begintijd ligt vóór het begin van de opname.';
$string['editor_publish'] = 'Publiceren';
$string['editor_publishblocked'] = 'Sommige ondertitels kunnen nog niet worden opgeslagen. Corrigeer ze vóór het publiceren.';
...
$string['editor_repaircue'] = 'Eindtijd corrigeren';
...
$string['editor_savedwithproblems'] = 'Opgeslagen wat kon worden opgeslagen; sommige ondertitels vragen aandacht.';
...
$string['player_exitfullscreen'] = 'Volledig scherm verlaten';
...
$string['player_fullscreen'] = 'Volledig scherm';

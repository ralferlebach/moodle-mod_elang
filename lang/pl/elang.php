...
$string['editor_cuenotsaved'] = 'Niezapisane';
...
$string['editor_gaphasalternatives'] = 'ma przyjmowane warianty';
$string['editor_gaphashints'] = 'ma podpowiedzi';
$string['editor_gapmode_exact'] = 'dokładna zgodność';
$string['editor_gapmode_wordrecognized'] = 'przyjmowane są zbliżone odpowiedzi';
$string['editor_gaprange'] = 'Pozycja luki (znaki)';
$string['editor_gapunplaceable_outofrange'] = 'Ta luka leży poza tekstem i nie da się jej pokazać na jej miejscu.';
$string['editor_gapunplaceable_overlap'] = 'Ta luka nakłada się na inną i nie da się jej pokazać na jej miejscu.';
...
$string['editor_problem_afterduration'] = 'Koniec wypada po końcu materiału.';
$string['editor_problem_endbeforestart'] = 'Koniec pokrywa się z początkiem lub go poprzedza.';
$string['editor_problem_negativestart'] = 'Początek wypada przed początkiem nagrania.';
$string['editor_publish'] = 'Opublikuj';
$string['editor_publishblocked'] = 'Niektórych napisów nie da się jeszcze zapisać. Popraw je przed opublikowaniem.';
$string['editor_published'] = 'Wersja opublikowana.';
$string['editor_removehint'] = 'Usuń podpowiedź';
$string['editor_removevariant'] = 'Usuń';
$string['editor_repaircue'] = 'Popraw koniec';
...
$string['editor_savedwithproblems'] = 'Zapisano to, co dało się zapisać; niektóre napisy wymagają uwagi.';
...
$string['player_exitfullscreen'] = 'Zakończ tryb pełnoekranowy';
...
$string['player_fullscreen'] = 'Pełny ekran';

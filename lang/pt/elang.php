...
$string['editor_gaphasalternatives'] = 'tem variantes aceites';
$string['editor_gaphashints'] = 'tem pistas';
$string['editor_gapmode_exact'] = 'correspondência exata';
$string['editor_gapmode_wordrecognized'] = 'respostas próximas aceites';
$string['editor_gaprange'] = 'Posição da lacuna (caracteres)';
$string['editor_gapunplaceable_outofrange'] = 'Este espaço fica fora do texto e não pode ser mostrado no seu lugar.';
$string['editor_gapunplaceable_overlap'] = 'Este espaço sobrepõe-se a outro e não pode ser mostrado no seu lugar.';

...
$string['editor_cuecount'] = '{$a} segment';
...
$string['editor_importedcues'] = '{$a} segment importerade.';
...
$string['editor_importreplacedcues'] = 'Segmenten ersattes med {$a} importerade segment.';
...
$string['elang:addinstance'] = 'Lägga till en ny språkövning';
$string['elang:attempt'] = 'Genomföra en språkövning';
...
$string['elang:view'] = 'Visa en språkövning';
...
$string['export_audiencestaff'] = 'Endast lärare och handledare — erbjuds inte deltagare';
...
$string['jarothreshold'] = 'Tröskel för ungefärlig matchning';
$string['jarothreshold_help'] = 'För luckor som godtar närliggande svar (algoritmen ”igenkänt ord”) är detta den minsta Jaro-likheten, från 0 till 1, mellan de reducerade formerna för att ett svar som inte är identiskt ändå ska räknas som rätt. Värdet 1 kräver en identisk reducering — ingen tolerans — medan lägre värden godtar större avvikelser. Nya versioner av den här aktiviteten utgår från det här värdet.';
$string['jarothresholdrange'] = 'Tröskeln måste ligga mellan 0 och 1.';
$string['language'] = 'Innehållsspråk';
$string['language_help'] = 'Språk- eller skriftkoden för övningens innehåll, till exempel de, fr, zh-Hans eller ja. Den styr hur svar jämförs, inklusive skiftläge och translitterering. Lämna tomt för allmän hantering. Nya versioner av den här aktiviteten utgår från det här värdet.';
...
$string['migratev1_parseerrorcount'] = '{$a} segment kunde inte tolkas';
...
$string['migratev1_verifieddiscrepancies'] = 'Verifieringen hittade {$a} avvikelse(r) mot källan från version 1:';
$string['migratev1_verifyfailed'] = 'Kunde inte verifiera den här aktiviteten: {$a}';
$string['modulename'] = 'Språkövning';
$string['modulename_help'] = 'Aktiviteten språkövning låter deltagare fylla i luckor i tidskodade undertexter medan de tittar på eller lyssnar till en video.
...
$string['player_finishincomplete'] = '{$a} lucka/luckor är fortfarande tomma. Slutföra försöket ändå?';
...
$string['pluginadministration'] = 'Administration av språkövning';
$string['pluginname'] = 'Språkövning';

...
$string['editor_cuenotsaved'] = 'Inte sparad';
...
$string['editor_gaphasalternatives'] = 'har godtagna varianter';
$string['editor_gaphashints'] = 'har ledtrådar';
$string['editor_gapmode_exact'] = 'exakt träff';
$string['editor_gapmode_wordrecognized'] = 'liknande svar godtas';
$string['editor_gaprange'] = 'Luckans position (tecken)';
$string['editor_gapunplaceable_outofrange'] = 'Den här luckan ligger utanför texten och kan inte visas på sin plats.';
$string['editor_gapunplaceable_overlap'] = 'Den här luckan överlappar en annan och kan inte visas på sin plats.';
...
$string['editor_problem_afterduration'] = 'Sluttiden ligger efter mediets slut.';
$string['editor_problem_endbeforestart'] = 'Sluttiden är densamma som starttiden eller ligger före den.';
$string['editor_problem_negativestart'] = 'Starttiden ligger före inspelningens början.';
$string['editor_publish'] = 'Publicera';
$string['editor_publishblocked'] = 'Några undertexter går inte att spara än. Rätta dem innan du publicerar.';
...
$string['editor_repaircue'] = 'Rätta sluttiden';
...
$string['editor_savedwithproblems'] = 'Sparade det som gick att spara; några undertexter behöver ses över.';
...
$string['player_exitfullscreen'] = 'Lämna helskärm';
...
$string['player_fullscreen'] = 'Helskärm';

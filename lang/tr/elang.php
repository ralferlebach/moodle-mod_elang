...
$string['editor_gaphasalternatives'] = 'kabul edilen çeşitlemeleri var';
$string['editor_gaphashints'] = 'ipuçları var';
$string['editor_gapmode_exact'] = 'tam eşleşme';
$string['editor_gapmode_wordrecognized'] = 'yakın yanıtlar kabul edilir';
$string['editor_gaprange'] = 'Boşluğun konumu (karakter)';
$string['editor_gapunplaceable_outofrange'] = 'Bu boşluk metnin dışında kalıyor ve yerinde gösterilemiyor.';
$string['editor_gapunplaceable_overlap'] = 'Bu boşluk bir başkasıyla çakışıyor ve yerinde gösterilemiyor.';

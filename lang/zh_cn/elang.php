...
$string['editor_gaphasalternatives'] = '有可接受的变体';
$string['editor_gaphashints'] = '有提示';
$string['editor_gapmode_exact'] = '完全匹配';
$string['editor_gapmode_wordrecognized'] = '接受相近答案';
$string['editor_gaprange'] = '空格位置（字符）';
$string['editor_gapunplaceable_outofrange'] = '该空缺位于文本之外，无法在原位显示。';
$string['editor_gapunplaceable_overlap'] = '该空缺与另一个重叠，无法在原位显示。';
